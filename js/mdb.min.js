    ...
    (n = [
      ...
      function (t, e, n) {
        ...
        class ka {
          ...
          _addColor(t, e) {
            Sa.find((t) => t === this._options.rippleColor.toLowerCase())
              ? L.addClass(
                  e,
                  ""
                    .concat(Ca, "-")
          ...
          static jQueryInterface(t) {
            return this.each(function () {
              return u.getData(this, xa) ? null : new ka(this, t);
            });
          }
          static getInstance(t) {
        ...
        Ta.forEach((t) => {
          O.one(document, "mousedown", t, ka.autoInitial(new ka()));
        }),
          a(() => {
            const t = s();
            if (t) {
              const e = t.fn[Ea];
              (t.fn[Ea] = ka.jQueryInterface),
                (t.fn[Ea].Constructor = ka),
                (t.fn[Ea].noConflict = () => (
                  (t.fn[Ea] = e), ka.jQueryInterface
                ));
            }
          });
        var Da = ka;
        const Na = "range",
          ja = "mdb.range";
        const Pa = "thumb-active";
        const Ma = ".".concat("thumb-value");
        n = ".".concat("range");
        class Ha {
          constructor(t) {
            (this._element = t),
              (this._initiated = !1),
              this._element && (u.setData(t, ja, this), this.init());
          }
          static get NAME() {
            return Na;
          }
          ...
          _updateValue() {
            const t = I.findOne(Ma, this._element);
          ...
          _showThumb() {
            L.addClass(this._element.lastElementChild, Pa);
          }
          _hideThumb() {
            L.removeClass(this._element.lastElementChild, Pa);
          }
          ...
          static jQueryInterface(n, i) {
            return this.each(function () {
              let t = u.getData(this, ja);
              var e = "object" == typeof n && n;
              if (
                (t || !/dispose/.test(n)) &&
                ((t = t || new Ha(this, e)), "string" == typeof n)
              ) {
                if (void 0 === t[n])
                  throw new TypeError('No method named "'.concat(n, '"'));
                t[n](i);
        ...
        I.find(n).map((t) => new Ha(t)),
          a(() => {
            const t = s();
            if (t) {
              const e = t.fn[Na];
              (t.fn[Na] = Ha.jQueryInterface),
                (t.fn[Na].Constructor = Ha),
                (t.fn[Na].noConflict = () => (
                  (t.fn[Na] = e), Ha.jQueryInterface
                ));
            }
          });
        var Ra = Ha;
